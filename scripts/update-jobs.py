#!/usr/bin/env python3
"""
nv-pay-hub/scripts/update-jobs.py
Daily job data updater — Nevada Pay Hub edition.
"""
...
def main():
        ...
        with open(raw_file) as f:
            for line in f:
                ...
                try:
                    ...
                    continue
                if not (20000 <= val_min < val_max <= 1_500_000):
                    continue
                job.setdefault("currency", "USD")
                job.setdefault("region", "NV")
    ...
    db["meta"] = {
        ...
        "updated": TIMESTAMP,
        "state": "Nevada",
        "law": "NRS § 613.133 Pay Transparency Act",
        "currency": "USD",
        "region": "NV",
    }
